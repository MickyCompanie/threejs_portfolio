...
The primary goal is to demonstrate my skills in a unique manner and create a lasting impact.
...
👉 **Immersive Hero**: An eye-catching 3D hacker room that responds to mouse movements.
...
```bash
git clone https://github.com/MickyCompanie/threejs_portfolio.git
...
In the root of the project duplicate the file named `.env.example` and rename it as `.env`. then replace the placeholder values with your actual EmailJS credentials. 
